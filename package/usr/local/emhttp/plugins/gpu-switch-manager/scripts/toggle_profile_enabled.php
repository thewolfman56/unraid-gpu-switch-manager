 ...
 * Enables or disables a profile for event monitoring
 */
...
if (!isset($profiles_data['profiles'][$profile_name])) {
    echo json_encode(array('success' => false, 'error' => 'Profile not found'));
    exit;
}

// Update profile enabled status
$profiles_data['profiles'][$profile_name]['enabled'] = ($enabled === 'true');
